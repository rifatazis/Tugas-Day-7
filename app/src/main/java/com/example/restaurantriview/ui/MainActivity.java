package com.example.restaurantriview.ui;
...
import com.example.restaurantriview.R;
import com.example.restaurantriview.data.response.CustomerReviewsItem;
import com.example.restaurantriview.data.response.PostReviewResponse;
import com.example.restaurantriview.data.response.Restaurant;
import com.example.restaurantriview.data.response.RestaurantResponse;
import com.example.restaurantriview.data.retrofit.ApiConfig;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void findRestaurant() {
        showLoading(true);
        Call<RestaurantResponse> client = ApiConfig.getApiService().getRestourant(RESTAURANT_ID);
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID,"Rifat", review);
